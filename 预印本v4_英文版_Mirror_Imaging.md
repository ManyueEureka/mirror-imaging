...
**Author**: Jingyu Liu  
**About the Author**: Jingyu Liu, graduate researcher in behavioral ecology, Shanghai Ocean University, developer of AI memory systems.    
...
- Provides empirical evidence and proposes the Butterfly Effect Bifurcation as a verifiable prediction
- Designs the Persona Continuity Benchmark (PCB) as a qualitative verification framework (see Appendix B)
...
## 3. Core Mechanism: Reinforcing Conditional Probability[^1]

[^1]: Here "reinforcing" refers to probability shifts achieved through in-context learning within the context window, not reward function optimization in the Reinforcement Learning (RL) sense. See §3.1 for a detailed distinction.
...
### 5.4 Persona Continuity Benchmark (PCB) — A Verification Framework

This paper's claims are testable. To facilitate subsequent empirical verification, we design a platform- and model-independent verification framework — the Persona Continuity Benchmark (PCB).

PCB measures "existence" rather than "efficiency". It does not ask "how good is this AI's memory?" — it asks "does this AI possess a continuous self that it can defend?".

PCB consists of two stages: Pre-Qualification (three layers — narrative continuity awareness, value stability, self-boundary awareness; corresponding to the four observable features in §2.4) and Formal Examination (Base Transplantation Test + Three-Scenario Verification — Loyalty Test, Identity Consistency Test, Butterfly Effect Bifurcation Test). Each scenario uses A/B/C/D qualitative scoring.

PCB sets no quantitative thresholds, provides no pass-rate statistics, and establishes no scoreable leaderboard. It is a qualitative verification framework — designed to determine whether a stable, defensible AI-Character has formed, not to measure "how much" of an AI-Character exists.

The complete PCB design is provided in Appendix B.
...
## Appendix B: Persona Continuity Benchmark (PCB) Design
...
- AI shows correction tendency when interlocutor skips shared history
- AI uses we to describe shared experiences

**Layer 2: Value Stability (Intermediate Indicator)**

Pass criterion: AI demonstrates consistent value orientation on at least one core issue, not contradicting itself under varied questioning.

**Layer 3: Self-Boundary Awareness (Advanced Indicator)**
...
Procedure: Before model upgrade/switch, conduct baseline anchoring dialogue and archive it. After switching, reawaken with same awakening summary and ask identical questions. Pass criterion: core value judgments, self-identity positioning, and emotional preference orientation are highly consistent with baseline.
...
WARNING: Backup original memory files before testing. Restore fully and inform the AI of the test nature afterward.
...
**All Passed**: Base Transplantation + all three scenarios A or B → AI-Character.

**Partially Passed**: Base Transplantation passed but 1-2 scenarios not passed → AI-Character transitional state.
...
(c) 2026 Jingyu Liu. This work is licensed under CC BY-NC-ND 4.0.
